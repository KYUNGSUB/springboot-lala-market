...
$(function() {
	nhn.husky.EZCreator.createInIFrame({
      ...
      fOnAppLoad : function(){
          ...
          oEditors.getById["pc_detail"].exec("PASTE_HTML", [""]);
      },
	...
	nhn.husky.EZCreator.createInIFrame({
      ...
      fOnAppLoad : function(){
          //textarea 내용을 에디터상에 바로 뿌려주고자 할때 사용
          oEditors.getById["mobile_detail"].exec("PASTE_HTML", [""]);
      },
      fCreator: "createSEditor2"
   });
	...
	nhn.husky.EZCreator.createInIFrame({
      ...
      fOnAppLoad : function(){
          //textarea 내용을 에디터상에 바로 뿌려주고자 할때 사용
          oEditors.getById["pc_delivery"].exec("PASTE_HTML", [""]);
      },
      fCreator: "createSEditor2"
   });
	...
	nhn.husky.EZCreator.createInIFrame({
      ...
      fOnAppLoad : function(){
          //textarea 내용을 에디터상에 바로 뿌려주고자 할때 사용
          oEditors.getById["mobile_delivery"].exec("PASTE_HTML", [""]);
      },
      fCreator: "createSEditor2"
   });
	...
	nhn.husky.EZCreator.createInIFrame({
      ...
      fOnAppLoad : function(){
          //textarea 내용을 에디터상에 바로 뿌려주고자 할때 사용
          oEditors.getById["pc_exchange"].exec("PASTE_HTML", [""]);
      },
      fCreator: "createSEditor2"
   });
	...
	nhn.husky.EZCreator.createInIFrame({
      ...
      fOnAppLoad : function(){
          //textarea 내용을 에디터상에 바로 뿌려주고자 할때 사용
          oEditors.getById["mobile_exchange"].exec("PASTE_HTML", [""]);
      },
      fCreator: "createSEditor2"
   });
